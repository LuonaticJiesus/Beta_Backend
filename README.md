...
| message_type        | IntegerField  | 101,102,103<br />201,202,203,204,205,206,207,208,209<br />301,302,303,304,305 | 模块更改产生的消息<br />帖子相关产生的消息<br />评论相关产生的消息 |
| time                | DateTimeField |                                                              | 消息产生的时间                                               |
| state               | IntegerField  |                                                              | 消息是否被查收                                               |
| sender_id           | IntegerField  | 可空                                                         | 消息产生的用户id（联表查询用户名、头像等）                   |
| ==sender_name==     |               |                                                              |                                                              |
| ==sender_avater==   |               |                                                              |                                                              |
| receiver_id         | IntegerField  |                                                              | 接收这条消息的用户id                                         |
| ==receiver_name==   |               |                                                              |                                                              |
| ==receiver_avater== |               |                                                              |                                                              |
| source_id           | IntegerField  |                                                              | 根据message_type，source_id代表block_id、post_id和comment_id其一<br />意义：消息来源的id<br />用于点击**跳转** |
...
| 功能               | message_type | sender_id                     | ==sender_name== | source_id（跳转）           | source_content                      | related_id                         | related_content                                              | point |
| ------------------ | ------------ | ----------------------------- | --------------- | --------------------------- | ----------------------------------- | ---------------------------------- | ------------------------------------------------------------ | ----- |
| 模块有新帖子       | 101          | block_id                      | block_name      | block_id                    |                                     | post_id                            | ”您关注的模块”+sender_name+“有新帖发布啦！“ + `post_title`   |       |
| **模块有新通知**   | 102          | block_id                      | block_name      | block_id                    |                                     | notice_id                          | ”您关注的模块”+sender_name+“有新通知！“ + `notice_content`   |       |
| 模块权限被改变     | 103          |                               | ”系统通知“      | block_id                    |                                     | block_id                           | ”您在“+`block_name`+”下的权限已更改“                         |       |
| 模块被删除         | 104          |                               | ”系统通知“      | block_id                    |                                     | block_id                           | ”您关注的模块”+`block_name`+“已被删除“                       |       |
|                    |              |                               |                 |                             |                                     |                                    |                                                              |       |
| 贴子发布扣积分     | 201          |                               | ”系统通知“      | post_id                     | post_title                          | post_id                            | ”您发布了一篇帖子，消耗积分==XX==“                           |       |
| 帖子被加精         | 202          |                               | “系统通知”      | post_id                     | post_title                          | post_id                            | ”您的帖子”+`post_title`+“被加精了“                           |       |
| 帖子被加精，加积分 | 203          |                               | ”系统通知“      | post_id                     | post_title                          | post_id                            | ”您的帖子”+`post_title`+“被加精了，积分增加==XX==“           |       |
| 帖子被取消加精     | 204          |                               | “系统通知”      | post_id                     | post_title                          | post_id                            | ”您的帖子“+`post_title`+被取消加精了，积分减少==XX==“        |       |
| 帖子被删除         | 205          |                               | “系统通知”      | post_id                     | post_title                          | post_id                            | ”您的帖子“+`post_title`+”因==不合规==被删除了，详细信息请联系助教/管理员“ |       |
